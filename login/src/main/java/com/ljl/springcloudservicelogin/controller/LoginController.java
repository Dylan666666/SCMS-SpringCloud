package com.ljl.springcloudservicelogin.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.ljl.springcloudservicelogin.bean.StaffA;
import com.ljl.springcloudservicelogin.entity.SupermarketStaff;
import com.ljl.springcloudservicelogin.entity.staff.*;
import com.ljl.springcloudservicelogin.exceptions.SupermarketStaffException;
import com.ljl.springcloudservicelogin.service.*;
import com.ljl.springcloudservicelogin.util.HttpServletRequestUtil;
        ...
        if (staffA != null && staffA.getStaffPhone() != null && staffA.getStaffPassword() != null) {
            try {
                ...
                if (relation != null || relation.size() != 0) {
                    System.out.println(relation.get(0).getStaffPositionId());
