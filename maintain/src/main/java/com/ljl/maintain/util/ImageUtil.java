...
public class ImageUtil {
     ...
     * 水印图片位置
     */
    private static ClassPathResource resource = new ClassPathResource("static/watermark.png");


    private static InputStream waterMark;

    static {
        try {
            waterMark = resource.getInputStream();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    @Test
    public void testImg(){
        File file = new File(this.getClass().getResource("/static/watermark.png").getPath());
