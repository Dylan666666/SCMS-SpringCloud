package com.ljl.warehouse.controller.warehouse;

import com.fasterxml.jackson.databind.JavaType;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ljl.warehouse.bean.*;
import com.ljl.warehouse.dto.ImageHolder;
import com.ljl.warehouse.entity.*;
import com.ljl.warehouse.entity.staff.Function;
import com.ljl.warehouse.entity.staff.StaffJurisdiction;
import com.ljl.warehouse.enums.DeliveryStatusStateEnum;
import com.ljl.warehouse.enums.ExportBillStatusStateEnum;
import com.ljl.warehouse.enums.StocktakingAllStatusStateEnum;
import com.ljl.warehouse.enums.StocktakingStatusEnum;
import com.ljl.warehouse.exceptions.SaleException;
import com.ljl.warehouse.exceptions.WareHouseManagerException;
import com.ljl.warehouse.service.*;
import com.ljl.warehouse.util.*;
...
public class WareHouseManagerController {
    ...
    public Map<String,Object> confirm(HttpServletRequest request) {
        ...
        try {
            ...
            exportBill.setExportSubmitStaffId(staffId);
            System.out.println(exportBill.toString());
            int res = exportBillService.update(exportBill);
            if (res == 0) {
                throw new WareHouseManagerException("提交失败");
            }
